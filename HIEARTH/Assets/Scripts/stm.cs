...
{
    #region Heart
    public Text appQuitTimeLabel;
    public Text heartRechargeTimer;
    public Text heartAmountLabel;
...
    public DateTime m_AppQuitTime = new DateTime(1970, 1, 1).ToLocalTime();
    public const int MAX_HEART = 5; //하트 최대값
...
    public IEnumerator OnApplicationFocus(bool value)
    {
